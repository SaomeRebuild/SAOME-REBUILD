        ...
        <div className="mt-10 space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-3">
              <p>
                <strong style={{ color: 'var(--color-primary)' }}>次級處理者</strong>
                — 為了提供服務，我們與協力廠商共享您的資料，包括：雲端託管：Cloudway 和 DigitalOcean。
              </p>
              <p>
                <strong style={{ color: 'var(--color-primary)' }}>國際資料傳輸</strong>
                — 由於我們的託管服務涉及 DigitalOcean（一家美國公司），您的個人資料可能被傳輸到歐洲經濟區以外的國家。我們確保傳輸的合法性：已與服務供應商簽訂最新的歐盟標準契約條款（SCCs），並實施了額外的技術和組織措施。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-inside list-disc space-y-1" style={{ color: 'var(--color-muted-foreground)' }}>
              {[
                ...
                <li key={title}>
                  <strong style={{ color: 'var(--color-primary)' }}>{title}</strong> — {desc}
                </li>
              ))}
            </ul>
          ...
          <section>
            ...
            <div className="space-y-3">
              <p>
                <strong style={{ color: 'var(--color-primary)' }}>資料保留</strong>
                — 我們只會將您的個人資料保留在實現本政策所述目的所需的期間內。一旦您的帳戶終止，我們將根據 DPA 規定的寬限期安全地刪除或匿名化您的資料。
              </p>
              <p>
                <strong style={{ color: 'var(--color-primary)' }}>安全性</strong>
                — 我們實施了嚴格的 TOMS 來保護您的資料免受未經授權的存取、披露或遺失。
              </p>
            </div>
          </section>
        </div>
